...
class _ExhibitionBottomSheetState extends State<ExhibitionBottomSheet> with SingleTickerProviderStateMixin {
  ...
  double lerp(double min, double max) {
    /// 5 bạn được 10 cái kẹo, 10 bạn được 20 cái kẹo
    /// => tối thiểu 1 bạn được 2 cái kẹo
    /// => giá trị tương ứng cho giá trị của _controller dựa theo min và max
  ...
  void _toggle() {
    ...
    _controller.fling(velocity: isOpen ? -2 : 2); // todo: -2:2???
  }
...
class ExpandedEventItem extends StatelessWidget {
  ...
  const ExpandedEventItem({Key key, this.topMargin, this.leftMargin, this.height, this.isVisible, this.borderRadius, this.title, this.date}) : super(key: key);
